...
public class TestData {
	...
	// CheckoutRecordEntry(LendableCopy copy, LocalDate checkoutDate, LocalDate
	// dueDate)
...
//		System.out.println(da.readPeriodicalsMap());
	...
	public void libraryMemberData() {
		LibraryMember libraryMember = new LibraryMember("1001", "Rishi", "Rogers", "641-223-2211", addresses.get(4));
